...
export default function AdminApp(){
 ...
 const active=staff.filter(s=>s.active),waiting=week.entries.filter(e=>e.status==='PM Approved'),approved=week.entries.filter(e=>e.status==='Admin Approved'),rejected=week.entries.filter(e=>e.status==='Rejected');
